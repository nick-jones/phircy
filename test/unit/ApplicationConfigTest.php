...
class ApplicationConfigTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCreateDefaultFactories() {
        ...
        $this->assertEquals('Symfony\Component\EventDispatcher\EventDispatcher', get_class($this->container['core.event_dispatcher']));
        $this->assertInternalType('array', $this->container['core.subscribers']);
        $this->assertEquals('Phipe\Connection\Stream\StreamFactory', get_class($this->container['core.transport_factory']));
    }
}